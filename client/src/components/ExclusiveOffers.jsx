    ...
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-32'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 w-full'>
            {exclusiveOffers.map((item)=>(
                <div 
                  key={item._id} 
                  className='group relative flex flex-col items-start justify-between gap-1 pt-12 md:pt-20 px-4 rounded-xl text-white bg-no-repeat bg-cover bg-center w-full h-64'
...
// const ExclusiveOffers = () => {
//   return (
//     <div className='flex flex-col item-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
//         <div className='flex flex-col md:flex-row items-center justify-between w-full'>
//             <Title align='left' title='Exclusive offers' subTitle='Take advantage of our limited-time offers and special packages to enhances your tay and create unforgettable memories.' />
//             <button className='group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12'>
//                 View All Offers
//                 <img className='group-hover:transition-x-1 transition-all' src={assets.arrowIcon} alt="arrow-icon" />
